				...
				<div class="" uk-grid>
					<div class="uk-width-2-3@l">
						...
						<div class="uk-card uk-card-body uk-background-default uk-card-small">
							<form method="post" action="" id="form_cv" enctype="multipart/form-data">
								<fieldset class="uk-fieldset">
									...
									<div class="uk-margin-medium">
										<input class="uk-input uk-input uk-input-search" type="text" name="titre_du_cv" placeholder="Titre du CV" value="<?= $data_redirect['titre_du_cv'] ? $data_redirect['titre_du_cv'] : ""; ?>">
										<hr>
									</div>
									<div class="uk-margin-medium">
											...
											<?php foreach ($terms as $term): ?>
												...
												<optgroup label="<?= $term->name ?>">
													...
													foreach ($childs as $child):
														...
														<option value="<?= $child->term_id ?>" <?php if(intval($data_redirect['categorie_emploi']) == intval($child->term_id)): ?> selected <?php endif; ?>> <?= $child->name ?></option>
                                                ...
                                                <table class="uk-table uk-table-small uk-table-divider">
                                                    <tr>
                                                        ...
                                                        <td class="uk-width-auto">
                                                            ...
                                                            <div class="uk-form-controls">
                                                                <input type="text" name="ecole_academic" class="uk-input uk-input-search" placeholder="Nom ecole">
                                                                <hr>
                                                            </div>
                                                            <div class="uk-form-controls">
                                                                <input type="text" name="annee_debut_academic" class="uk-input uk-input-search datepicker_year_start" placeholder="Année début" readonly="true">
                                                                <hr>
                                                            </div>
                                                            <div class="uk-form-controls">
                                                                <input type="text" name="annee_fin_academic" class="uk-input uk-input-search datepicker_year_end" placeholder="Annéé fin" readonly="true">
                                                                <hr>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ...
                                                <div data-repeater-item>
                                                    <table class="uk-table uk-table-small uk-table-divider">
                                                        <tr>
                                                            ...
                                                            <td class="uk-width-auto">
                                                                <div class="uk-form-controls">
                                                                    <input type="text" name="nom_entreprise" class="uk-input uk-input-search" placeholder="Nom de l'entreprise"/>
                                                                    <hr>
                                                                </div>
                                                                <div class="uk-form-controls">
                                                                    <textarea name="description_poste" class="uk-textarea uk-input-search" style="height: auto !important;" cols="30" rows="5" placeholder="Description du poste"></textarea>
                                                                    <hr>
                                                                </div>
                                                                <div class="uk-form-controls">
                                                                    <input type="text" name="date_debut_emploi" class="uk-input uk-input-search datepicker_start" placeholder="Date debut : dd/mm/yyyy" readonly="true">
                                                                    <hr>
                                                                </div>
                                                                <div class="uk-form-controls">
                                                                    <input type="text" name="date_fin_emploi" class="uk-input uk-input-search datepicker_end" placeholder="Date fin : dd/mm/yyyy" readonly="true">
                                                                    <hr>
                                                                </div>
                                                            </td>
                                                        </tr>
