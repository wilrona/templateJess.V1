...
<?php /* Template Name: Page qui sommes nous ? */ ?>
...
<?php while ( have_posts() ) : the_post(); ?>
    ...
    <div class="uk-header">
        ...
        $slider = tr_posts_field('aboutslider');
        ...
        <div class="uk-grid-small uk-flex" uk-grid>
                    ...
                    <div class="uk-padding uk-background-default">
                        <div class="" uk-grid>
                            <div class="uk-width-1-2@l">
                                <h2 class="uk-h1"><?= tr_posts_field('secondtitle') ?></h2>
                                <div>
            ...
            <?php if(tr_posts_field('titrebienvenu')): ?>
            <div class="uk-width-1-1 uk-section uk-section-small">
                <div class="uk-container">
                    <div class="uk-padding uk-background-default">
                        <div class="" uk-grid>
                            <div class="uk-width-1-2@l">
                                <h2 class="uk-h1"><?= tr_posts_field('titrebienvenu') ?></h2>
                                <div>
							        <?php wpautop(tr_posts_field('textebienvenu')) ?>
                                </div>
                            </div>
                            <div class="uk-width-1-2@l">
                                <img src="<?php echo get_the_post_thumbnail_url(tr_posts_field('textebienvenu')[0]); ?>" alt="" class="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php
                $valeurs = tr_posts_field('valeurs');
                if($valeurs):
            ?>
            ...
            <div class="uk-width-1-1 uk-section uk-section-small">
                <div class="uk-container">
                    <div class="uk-text-center uk-margin-medium-bottom">
                        <h2 class="uk-h1 uk-text-jess uk-text-uppercase">Nos valeurs</h2>
                    </div>
